...
namespace LJ
{
	namespace StF
	{
		...
		{
			csl_allocator* csys_scalar_deleting_destructor;
			void* D3DDevice; // True purpose unknown
			void* D3DDevice2; // True purpose unknown
			unsigned int one;
			csl_allocator* isl_scalar_deleting_destructor;
			void* cpipeline_state_library_allocator_t_unk1;
			void* cpipeline_state_library_allocator_t_block_size;
			void* cpipeline_state_library_allocator_t_unk2;
			void* _cpipeline_state_library_allocator_t_block_size0;
			void* _guard_check_ical0;
			void* _guard_check_ical1;
		};
	}
