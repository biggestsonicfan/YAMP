...
static_assert(offsetof(m2ftg::gs::context_t, handle_mesh) == 0x107A98, "handle_mesh offset drift");
static_assert(offsetof(m2ftg::gs::context_t, handle_tex)  == 0x107AB8, "handle_tex offset drift");
static_assert(offsetof(m2ftg::gs::context_t, handle_fx)   == 0x107BB8, "handle_fx offset drift");
...
static_assert(offsetof(m2ftg::gs::context_t, p_vb_sphere) == 0x7640, "p_vb_sphere offset drift");
static_assert(offsetof(m2ftg::gs::context_t, p_ib_quad) == 0x7670, "p_ib_quad offset drift");
static_assert(offsetof(m2ftg::gs::context_t, p_ib_fan)  == 0x7678, "p_ib_fan offset drift");
static_assert(offsetof(m2ftg::gs::context_t, p_device_context) == 0x7738, "p_device_context offset drift");
